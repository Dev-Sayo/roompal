...
const loadMyProperties = async () => {
  ...
  try {
    ...
    // Show loading
    container.innerHTML =
      '<div class="text-center py-10"><div class="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-[#223448]"></div><p class="mt-4 text-gray-600">Loading your properties...</p></div>';
